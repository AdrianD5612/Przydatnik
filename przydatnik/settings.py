"""
Django settings for przydatnik project.
...
ALLOWED_HOSTS = ['192.168.2.44', '127.0.0.1', '192.168.2.249', '192.168.2.248', ]
...
WSGI_APPLICATION = 'przydatnik.wsgi.application'
